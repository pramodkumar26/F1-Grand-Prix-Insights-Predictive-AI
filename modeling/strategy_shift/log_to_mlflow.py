...
REGISTERED_MODEL_NAME = 'f1-strategy-shift'
...
def main():
    ...
    common_params = {
        ...
        'train_years': '2018-2023', 'val_year': '2023 (shared with train)', 'test_years': '2024-2026',
        'note': 'explanatory model, uses in-race features on purpose, not a pre-race forecast',
    }
    ...
    with mlflow.start_run(run_name='strategy-shift-baseline-linear'):
    ...
    with mlflow.start_run(run_name='strategy-shift-primary-xgboost'):
        mlflow.log_params({
